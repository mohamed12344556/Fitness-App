...
- **🤖 تنبؤات الطقس بالذكاء الاصطناعي**
  - توصيات ذكية بناءً على بيانات الطقس
  - نصائح مخصصة لتحديد مدى ملائمة الأنشطة الخارجية
  - تحليل عوامل متعددة (درجة الحرارة، الرطوبة، حالة الطقس)
  - واجهة سهلة الاستخدام للحصول على النصائح
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <img src="assets/screenshots/ai_prediction_screen1.png" width="200px" alt="تنبؤات الذكاء الاصطناعي"/>
      <br/>تنبؤات الذكاء الاصطناعي
    </td>
  </tr>
  <tr>
    <td align="center">
      <img src="assets/screenshots/ai_prediction_screen2.png" width="200px" alt="نتائج التنبؤ"/>
      <br/>نتائج التنبؤ
    </td>
    <td align="center">
...
- **Shared Preferences**: لتخزين تفضيلات المستخدم
...
- [x] إضافة نظام تنبؤ بالطقس يعتمد على الذكاء الاصطناعي
- [x] تقسيم واجهة المستخدم إلى مكونات قابلة لإعادة الاستخدام
- [x] ضمان تجربة مستخدم سلسة عبر جميع الأجهزة
...
- [ ] تحسين دقة نموذج التنبؤ بالذكاء الاصطناعي
- [ ] توسيع نطاق تغطية البيانات المناخية
